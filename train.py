...
H, W = 480, 640
FINETUNE = False
IMAGE_PATHS = 'Dataset/train_image'
MASK_PATHS = 'Dataset/train_mask'
VAL_IMAGE_PATH = 'Dataset/val_image'
...
def network(image_tensor, is_training):
    """Runs image through the network and returns predicted mask."""

    print('Building Network for network...')
